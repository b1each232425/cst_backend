		...
		// 以下为POST方法的测试用例
		{
			...
			args: args{
				...
				body: DomainData{
					...
					APIs: []*cmn.TAPI{
						{
							ID: null.NewInt(20074, true),
						},
						{
							ID: null.NewInt(20159, true),
						},
						{
							ID: null.NewInt(20160, true),
						},
						{
							ID: null.NewInt(20162, true),
						},
						{
							ID: null.NewInt(20163, true),
						},
					},
				},
				forceError: "",
