...
//				}
//				// 这里直接使用函数插入
//				examPaperID1, _, err = GenerateExamPaper(context.Background(), tx2, uid.Int64, uid.Int64, false)
//				if err != nil {
//					t.Fatalf("生成考卷逻辑出错：%v", err)
//				}
//				if examPaperID1 == nil {
...
//				}
//
//				examPaperID2, _, err = GenerateExamPaper(context.Background(), tx2, uid.Int64, uid.Int64, false)
//				if err != nil {
//					t.Fatalf("生成考卷逻辑出错：%v", err)
//				}
//				if examPaperID2 == nil {
