...
func Test_canUpdateInvigilationInfo(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			examRoomID:    null.IntFrom(testExamRoomID),
			forceErr:      "",
			centralServer: true,
			wantCanUpdate: false,
			wantErr:       false,
...
func Test_invigilationFile(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			userRole:      2002,
			method:        "DELETE",
			file:          InvigilationFile{ExamSessionID: testOfflineExamSessionID, ExamRoomID: null.IntFrom(testExamRoomID), FileID: 0},
			wantErr:       true,
		...
		},
		{
			...
			userRole:      2002,
			method:        "DELETE",
			file:          InvigilationFile{ExamSessionID: testOfflineExamSessionID, ExamRoomID: null.IntFrom(testExamRoomID), FileID: testFile1ID},
			wantErr:       true,
			errorContains: "强制读取请求体错误",
		},
		{
		...
		},
		{
			...
			userRole:      2002,
			method:        "DELETE",
			file:          InvigilationFile{ExamSessionID: 0, ExamRoomID: null.IntFrom(testExamRoomID), FileID: 0},
			wantErr:       true,
			errorContains: "无效的考试场次ID",
		},
		{
			...
			userRole:      2002,
			method:        "DELETE",
			file:          InvigilationFile{ExamSessionID: testOfflineExamSessionID, ExamRoomID: null.IntFrom(0), FileID: testFile1ID},
			wantErr:       true,
