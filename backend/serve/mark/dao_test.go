...
//			}
//
//			results, err := QueryStudentAnswers(ctx, tt.answerType, tt.cond, tt.markerInfo)
//
...
//				MarkMethod: "00",
//			},
//			forceErr:       "QuerySubjectiveQuestions-pgxConn.Query",
...
//				MarkMethod: "00",
//			},
//			forceErr:       "QuerySubjectiveQuestions-rows.Scan",
//			expectedErrStr: "unable to scan row data",
//		},
//		{
...
//			}
//
//			list, err := QuerySubjectiveQuestions(ctx, tt.cond, tt.markerInfo)
//			data, e := json.Marshal(list)
//			if e != nil {
